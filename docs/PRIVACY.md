...
|---|---|---|---|
| **Anonymous heartbeat** | `srctyff5.us-east.insforge.app` | A one-way hash of the machine id, app version, OS platform, and shell (`cli` / `mac` / `win` / `linux`). Nothing else. | At most once per day |
